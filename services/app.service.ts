...
export interface AppVaccineProvincesResponse {
  data: VaccineProvince[];
}

export const fetchAppVaccineProvinces =
  async (): Promise<AppVaccineProvincesResponse> => {
    return await axiosAppClient.get('/vaccine/provinces');
  };
